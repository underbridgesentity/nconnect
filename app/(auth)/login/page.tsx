...
export const metadata: Metadata = {
  title: "Sign in",
  description:
    "Sign in to your Needd Connect portal with a code sent to your email address.",
  robots: { index: false },
};
...
export default async function LoginPage({
  ...
  // account is wrong: they are signed in, so nothing on a sign-in form is
  ...
  return (
    <div className="rounded-3xl border bg-card p-6 shadow-sm sm:p-7">
      ...
      <p className="mt-1.5 text-sm text-muted-foreground">
        {callbackUrl
          ? "Verify your email address and we will take you straight back to where you were."
          : "We send a 6-digit code to your email address. No password to remember."}
      </p>

      <SignInNoticeCard notice={notice} />

      <OtpLoginForm callbackUrl={callbackUrl ?? undefined} />
